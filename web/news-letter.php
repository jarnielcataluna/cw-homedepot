...
$body .= '                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" class="deviceWidth">';
$body .= '                                    <tr>';
$body .= '                                        <td style="padding:0;"><img src="images/banner.jpg" alt="" width="100%" style=="display:block;" class="deviceWidth"></td>';
$body .= '                                    </tr>';
$body .= '                                </table>';
$body .= '                            </td>';
$body .= '                        </tr>';
...
$body .= '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($data['code'], $generator::TYPE_EAN_13, 2, 100, array(0,0,0))) . '">';
$body .= '                                                    </td>';
$body .= '                                                </tr>';
$body .= '                                            </table>';
$body .= '                                        </td>';
...
$body .= '                                <img src="images/logo.png" alt="">';
...
$body .= '                                            <a href="#" style="display: inline-block; margin: 0px 3px;"><img src="images/icon-fb.png" alt="" style="display: block;"></a>';
$body .= '                                            <a href="#" style="display: inline-block; margin: 0px 3px;"><img src="images/icon-twitter.png" alt="" style="display: block;"></a>';
$body .= '                                            <a href="#" style="display: inline-block; margin: 0px 3px;"><img src="images/icon-linkedin.png" alt="" style="display: block;"></a>';
$body .= '                                        </td>';
$body .= '                                    </tr>';
$body .= '                                </table>';
$body .= '                            </td>';
